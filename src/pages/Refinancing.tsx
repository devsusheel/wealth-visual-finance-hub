      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <RefreshCw className="h-16 w-16 text-cyan-300 mx-auto mb-6" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center hover:shadow-xl transition-shadow">
              <CardHeader>
                <PiggyBank className="h-12 w-12 text-cyan-500 mx-auto mb-4" />
            ...
            <Card className="text-center hover:shadow-xl transition-shadow">
              <CardHeader>
                <Home className="h-12 w-12 text-cyan-500 mx-auto mb-4" />
